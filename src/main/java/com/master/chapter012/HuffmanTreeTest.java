...
//最佳实践--数据压缩（创建赫夫曼树）
    //将给出的一段文本，比如“i like like like java do you like a java”,根绝前面的赫夫曼编码原理，对其进行数据压缩处理 ，形式如
        //“10010011000100010001000011000010001000100001000...”
    //步骤1：根据赫夫曼编码压缩数据的原理，需要创建“i like lile lile java do you like a java”
        //对应的赫夫曼树
        //思路：
            //1:Node{data:存放数据，weight:权值，left,right}
            //2:得到字符串的byte数组（byte[]）
            //3:编写方法，将准备构建赫夫曼树的Node节点放在List数组【Node{data=97,weight=5},Node{data=32,weight=9}...】
            //4：通过List创建对应的赫夫曼树
            //5:生成赫夫曼树对应的赫夫曼编码：‘ ’=01,a=100,d=11000,u=11001,e=1110,v=11011....（向左为0，向右为1）
            //6:使用赫夫曼编码来生成赫夫曼编码数据，即按照上面的赫夫曼编码，将‘i like lile lile java do you like a java’转换成“10010011000110..”形式
    //代码实现见HuffmanCode类
